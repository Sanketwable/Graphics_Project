...
//for colors i.e colors
    ...
    palette(-0.8,-0.93,-0.75,-0.93,-0.75,-0.88,-0.8,-0.88);//1.1
    glColor3f(1,1,1);
    palette(-0.74,-0.93,-0.69,-0.93,-0.69,-0.88,-0.74,-0.88);//2.2
     glColor3f(0.4,0.6,0.8);
    palette(-0.68,-0.93,-0.63,-0.93,-0.63,-0.88,-0.68,-0.88);//3.3
     glColor3f(0.8,0.6,0.4);
    palette(-0.62,-0.93,-0.57,-0.93,-0.57,-0.88,-0.62,-0.88);//4.4
     glColor3f(1,0.5,1);
    palette(-0.56,-0.93,-0.51,-0.93,-0.51,-0.88,-0.56,-0.88);//5.5
     glColor3f(0.9,0.7,0.1);
    palette(-0.50,-0.93,-0.45,-0.93,-0.45,-0.88,-0.50,-0.88);//6.6
     glColor3f(0.6,0.2,0.9);
    palette(-0.44,-0.93,-0.39,-0.93,-0.39,-0.88,-0.44,-0.88);//7.7
     glColor3f(0.1,0.9,0.4);
    palette(-0.38,-0.93,-0.33,-0.93,-0.33,-0.88,-0.38,-0.88);//8
